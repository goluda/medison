Public Class WindowSkierowanieDoPracowniRezonansuMagnetycznego
    ...
    Private Sub WindowSkierowanieDoPracowniRezonansuMagnetycznego_Closing(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Me.Closing
        s.xml = ObslugaSkierowania.ZapiszSkierowanie(Me.FlowDocument1, "Do pracowni rezonansu magnetycznego").ToString
    End Sub
