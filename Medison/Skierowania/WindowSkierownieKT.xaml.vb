Public Class WindowSkierownieKT
    Dim p As Pacjenci
    ...
    Private Sub WindowSkierowanieDoPracowniRezonansuMagnetycznego_Closing(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Me.Closing
        s.xml = ObslugaSkierowania.ZapiszSkierowanie(Me.FlowDocument1, "KT").ToString
    End Sub
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.Windows.RoutedEventArgs)
        Dim doc = ObslugaSkierowania.ZapiszSkierowanie(Me.FlowDocument1, "KT")
